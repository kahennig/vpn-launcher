...
| W014 | Escalación de privilegios real en Windows (UAC o Interactive Service) | ✅ DONE | elevate_command() en Windows no eleva; sin servicio ni admin la conexión falla silenciosamente |
